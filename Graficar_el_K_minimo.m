...
%K_min = K_minimo(Dt,g,m,Fmax,P0x,P0y,P0z,V0x,V0y,V0z,alpha,gamma,K,tolerancia);
K_min = 20;
K = K_min;
[sol,optimvalue] = Algoritmo(Dt,g,m,Fmax,P0x,P0y,P0z,V0x,V0y,V0z,alpha,gamma,K_min);

% Dibujamos la trayectoria y la pendiente de planeo mínima
...
leg = legend('Location','best','FontSize',14);
title(leg,["Tiempo de aterrizaje (K = 20): ",num2str(K*Dt)]);
